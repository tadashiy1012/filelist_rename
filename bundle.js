...
var _FlistItem = require('./FlistItem.jsx');

var _FlistItem2 = _interopRequireDefault(_FlistItem);
...
var Flist = function (_React$Component) {
    _inherits(Flist, _React$Component);

    function Flist(props) {
        _classCallCheck(this, Flist);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(Flist).call(this, props));
    }

    _createClass(Flist, [{
        key: 'render',
        value: function render() {
            var childNode = this.props.files.map(function (file) {
                console.log(file);
...
},{"./FlistItem.jsx":3,"react":173}],2:[function(require,module,exports){
'use strict';
...
var _Flist = require('./Flist.jsx');

var _Flist2 = _interopRequireDefault(_Flist);

var _RenameList = require('./RenameList.jsx');

var _RenameList2 = _interopRequireDefault(_RenameList);

var _RenameBox = require('./RenameBox.jsx');
...
var FlistBox = function (_React$Component) {
    _inherits(FlistBox, _React$Component);

    function FlistBox(props) {
        _classCallCheck(this, FlistBox);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(FlistBox).call(this, props));
    ...
    _createClass(FlistBox, [{
        ...
        value: function handleOpenFolder() {
            ...
            remote.require('./mapFilelist')(function (arg, path) {
                _this2.path = path;
                var files = arg.map(function (file) {
                    return { name: file };
                });
                _this2.setState({ files: files, rfiles: files, origin: files });
            });
        }
    }, {
        key: 'handleRenamePreview',
        value: function handleRenamePreview(newName) {
            var files = this.state.origin.map(function (file) {
                return { name: newName + file.name };
            });
            this.setState({ rfiles: files });
        }
    }, {
        key: 'handleExecRename',
        value: function handleExecRename() {
            if (window.confirm('Are you sure?')) {
                var pairLs = [];
                for (var i = 0, len = this.state.files.length; i < len; i++) {
                    var pair = [this.state.files[i].name, this.state.rfiles[i].name];
                    pairLs.push(pair);
                }
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'td',
                            null,
                            _react2.default.createElement(_Flist2.default, { files: this.state.files })
                        ),
                        _react2.default.createElement(
                            'td',
                            null,
                        ...
                        _react2.default.createElement(
                            'td',
                            null,
                            _react2.default.createElement(_RenameList2.default, { files: this.state.rfiles })
                        )
                    )
                ),
                _react2.default.createElement('br', null),
                _react2.default.createElement(_RenameBox2.default, {
...
exports.default = FlistBox;

},{"./Flist.jsx":1,"./RenameBox.jsx":4,"./RenameList.jsx":5,"react":173}],3:[function(require,module,exports){
'use strict';
...
var Flistitem = function (_React$Component) {
    _inherits(Flistitem, _React$Component);

    function Flistitem(props) {
        _classCallCheck(this, Flistitem);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(Flistitem).call(this, props));
    }

    _createClass(Flistitem, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'option',
...
var RenameBox = function (_React$Component) {
    _inherits(RenameBox, _React$Component);

    function RenameBox(props) {
        _classCallCheck(this, RenameBox);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(RenameBox).call(this, props));

        _this.handleUpdatePreview = _this.handleUpdatePreview.bind(_this);
        _this.handleExecRename = _this.handleExecRename.bind(_this);
        return _this;
    }

    _createClass(RenameBox, [{
        key: "handleUpdatePreview",
        value: function handleUpdatePreview(e) {
            e.preventDefault();
        ...
        key: "handleExecRename",
        value: function handleExecRename(e) {
            e.preventDefault();
        ...
        value: function render() {
            return React.createElement(
                "div",
                null,
                React.createElement("input", { type: "text", onChange: this.handleUpdatePreview }),
                React.createElement("br", null),
                React.createElement(
                    "button",
                    { onClick: this.handleExecRename },
                    "exec rename"
                )
            );
        }
...
var RenameList = function (_React$Component) {
    _inherits(RenameList, _React$Component);

    function RenameList(props) {
        _classCallCheck(this, RenameList);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(RenameList).call(this, props));
    }

    _createClass(RenameList, [{
        key: 'render',
        value: function render() {
            var childNode = this.props.files.map(function (file) {
                return _react2.default.createElement(
...
exports.default = RenameList;

},{"./FlistItem.jsx":3,"react":173}],6:[function(require,module,exports){
'use strict';
...
var _FlistBox = require('./FlistBox.jsx');

var _FlistBox2 = _interopRequireDefault(_FlistBox);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(_react2.default.createElement(_FlistBox2.default, null), document.getElementById('root'));

},{"./FlistBox.jsx":2,"react":173,"react-dom":35}],7:[function(require,module,exports){
(function (process){
'use strict';
